...
Privacy:
  - Only contrastive structure is shared—no raw features or predictions.
  - Feature-level privacy: device model never accesses personalized features.
  - The contrastive objective does not require label sharing.
